...
public interface MongoMetadataService {
    ...
    List<FileContent> copyFiles(String[] names, List<FileContent> files, FileContent targetedLocation, String targetPath, boolean isRename, String action) throws Exception;
    List<FileContent> moveFiles(String[] names, List<FileContent> files, FileContent targetedLocation, String targetPath, boolean isRename, String action) throws Exception;
